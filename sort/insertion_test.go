...
func TestInsertion(t *testing.T) {
	...
	t.Run("Integers", func(t *testing.T) {
		...
		Insertion(ints, func(a, b int) bool { return a < b })
		for i, v := range ints {
			if v != expected[i] {
	...
	t.Run("Floats", func(t *testing.T) {
		...
		Insertion(floats, func(a, b float64) bool { return a < b })
	...
	t.Run("Strings", func(t *testing.T) {
		...
		Insertion(strs, func(a, b string) bool { return a < b })
		for i, v := range strs {
			if v != expected[i] {
	...
	t.Run("CustomType", func(t *testing.T) {
		...
		Insertion(people, func(a, b Person) bool { return a.Age < b.Age })
